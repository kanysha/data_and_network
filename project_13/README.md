...
```bash
go run ./project_14/cmd/tcp_server
```

Во втором терминале запустите интерактивный клиент:

```bash
go run ./project_14/cmd/tcp_client
```
...
```bash
go run ./project_14/cmd/udp_server
```

Во втором терминале:

```bash
go run ./project_14/cmd/udp_client
```
