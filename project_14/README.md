...
```bash
go run ./project_15/cmd/url_shortener
...
```bash
go run ./project_15/cmd/retry_client
go run ./project_15/cmd/retry_client -url https://httpbin.org/status/500 -retries 2
```
...
```bash
go run ./project_15/cmd/service_checker
go run ./project_15/cmd/service_checker https://go.dev https://github.com
```
